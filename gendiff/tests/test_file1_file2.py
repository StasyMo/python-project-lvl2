...
def main():
    ...
    file_1_file2 = open('gendiff/tests/fixtures/corr_answer_file1_first.json')
    equal_files = open('gendiff/tests/fixtures/corr_answer_equal.json')
    file_2_file1 = open('gendiff/tests/fixtures/corr_answer_file2_first.json')
